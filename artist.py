...
label = "track-data"+os.urandom(4).hex()
label = label.encode()
...
listener_pubkeys = get_listener_pubkeys()

# We create a view of the Bob who's going to be granted access.
active_listener = Bob.from_public_keys(verifying_key=listener_pubkeys['sig'],
                                      encrypting_key=listener_pubkeys['enc'],
                                      federated_only=True)
