...
const ERR_MSG = "Usage: Pass in either 'add' or 'remove' to add or remove mappings from host file."
...
const verifyNotAlreadyAdded = lines => !lines.some(l => (l.search(START_SENTINEL) !== -1))
